      ...
      $total=$total+$article['prixArt']*$article['quantite'];
        echo '<div class="article">
            ...
            <div class="total-article">
              ...
              <button type="submit" name="suppression" value="'.$article['code_article'].'  " > Supprimer</button>
...
if (isset($_SERVER['HTTP_REFERER'])) {
   ...
   /// echo "  URL de la page précédente : " . 
    echo '<button class="btn-vider-retour">
            <a href="'.$previousPage.'" class="">Continuer mes achats</a>
          </button>';

} else {
    echo "Aucune URL de page précédente n'est disponible.";
  //  $previousPage="";
}
